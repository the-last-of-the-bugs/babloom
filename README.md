...
* 🦋 **Framework agnostic** — Build with TypeScript and use the same editor core across frameworks
* ⚛️ **React support**
* 💚 **Vue support**
* 🧡 **Svelte support**
...
Before contributing, please read the contributing guidelines and check existing issues and discussions.
...
> One editor core. React, Vue, and Svelte.

**Extensibility**

> Build features through extensions instead of modifying the core.

**Developer experience**

> TypeScript-first APIs, excellent documentation, and an interactive playground.
